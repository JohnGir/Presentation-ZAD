<template>
  ...
  >
    ...
    <path
      ...
      :id="item._id"
      :data-name="item['_data-name']"
      :data-id="item['data-id']"
      :d="item._d"
      :style="item._style"
      @click="contry_clicked(item)"
    />
  </svg>
</template>
...
export default defineComponent({
  ...
  methods: {
    contry_clicked(item) {
      if (item._style != 'fill:' + this.fillcolor) {
        item._style = 'fill:' + this.fillcolor;
      } else {
        item._style = 'fill:white;';
      }
    },
  },
  props: {
...
const geodata = [
  ...
  },
  {
    ...
    '_data-name': 'Burundi',
    '_data-id': 'BI',
    _d: 'm 669,556.1 -0.6,-5.4 0,0 -6.5,-0.9 -3.8,7.9 -7.4,-1.1 3,6.3 0.1,2.4 4.3,13.2 0,0.6 1.2,-0.2 4.5,-5 4.9,-7.2 3,-2.9 -0.1,-4.5 -2.6,-3.2 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'Benin',
    '_data-id': 'BJ',
    _d: 'm 340,356 -9.3,-8 -4.3,0.1 -4.1,4 -2.6,4.2 -6,1.2 -2.5,6.1 -4.1,1.6 -1.6,7.2 3.7,4.1 4.3,4.9 0.4,6.8 2.5,2.8 -0.5,31.8 3,9.5 10.1,-1.6 0.6,-22.3 -0.3,-8.8 2.3,-8.7 3.7,-4.3 5.9,-8.5 -1.3,-3.7 2.4,-5.6 -2.8,-8.2 0.5,-4.6 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    _id: 'BF',
    '_data-name': 'Burkina Faso',
    '_data-id': 'BF',
    _d: 'm 300.7,310.8 -7.8,0 -3,-2.6 -6.7,1.9 -11.3,5.8 -2.3,4.3 -9.4,6.2 -1.7,3.6 -5.1,2.8 -5.8,-1.9 -3.4,3.4 -1.8,9.5 -9.7,11.4 0.3,4.7 -3.4,5.9 0.8,8 5.5,3 2.1,4.6 5.4,2.9 4.3,-3.4 5.7,-0.6 8.3,3.6 -1.6,-10.4 0.3,-7.9 21.1,-0.6 5.4,1 3.9,-2.2 5.6,1.1 10.7,0.3 4.1,-1.6 2.5,-6.1 6,-1.2 2.6,-4.2 0.3,-9.5 -14,-3.1 -0.4,-6.7 -6.9,-9 -1.6,-6.3 1,-6.7 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Djibouti',
    '_data-id': 'DJ',
    _d: 'm 820.3,358.7 -5.3,-3.8 6.8,-3.3 0.1,-5.7 -3,-4.3 -3.6,3.4 -5.2,-1.2 -4,6.1 -3.9,6.5 1.1,3.8 0.3,4.2 6.8,0.2 2.9,-0.9 2.8,2.4 4.2,-7.4 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Eritrea',
    '_data-id': 'ER',
    _d: 'm 777.6,303.8 -7,-6.8 -4,-12.7 -7.8,-16 -5.7,7.9 -8.8,2.3 -3.6,4.2 -0.7,9.2 -4.3,20.3 1.5,5.6 14.3,2.9 3.3,-10.4 7.6,6.3 7,-3.2 3,2.9 8.3,0.1 10.8,5.6 3.4,4.8 5.5,4.4 5.4,8.1 4.3,4.5 5.2,1.2 3.6,-3.4 -6.2,-4.2 -4,-4.7 -6.9,-8 -7.1,-7.9 -17.1,-13 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Gabon',
    '_data-id': 'GA',
    _d: 'm 455.9,485.9 -1.5,-0.7 -7.3,1.8 -7.4,-1.9 -5.8,0.9 0.1,16.7 -17.7,-0.2 -4.2,0.8 -2.4,10.3 -3,10.1 -2.7,4.4 -0.3,4.6 7.3,14.3 8.1,11.4 12.5,14 9.3,-7.7 -4.6,-9.1 4.2,-3.5 8.3,-1.7 1,-6.1 6.5,6.6 10.8,0.6 3.7,-6.5 1.6,-9.2 -1.3,-10.8 -5.8,-8.2 5.3,-16.1 -3.1,-2.7 -9.1,1.1 -3.4,-7.1 0.9,-6.1 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'Ghana',
    '_data-id': 'GH',
    _d: 'm 296.4,364.9 -5.6,-1.1 -3.9,2.2 -5.4,-1 -21.1,0.6 -0.3,7.9 1.6,10.4 3.2,19.7 -5.1,11.6 -3.2,15.6 5.2,11.9 -0.5,5.5 10.9,3.9 11,-4 6.7,-4.7 19.2,-8.1 -2.8,-4.9 -3.2,-8.8 -1,-6.8 2.7,-12.5 -3,-5 -1.2,-10.9 0,-10.1 -5.1,-7.1 0.9,-4.3 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Gambia',
    '_data-id': 'GM',
    _d: 'm 91.9,335.4 11,0.2 3,-1.9 2.2,-0.1 4.5,-3.2 5.2,2.9 5.2,0.3 5.3,-3.1 -2.4,-4 -4,2.3 -3.8,-0.1 -4.7,-3.4 -3.8,0.2 -2.8,3.3 -13.2,0.4 -1.7,6.2 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    _id: 'GW',
    '_data-name': 'Guinea-Bissau',
    '_data-id': 'GW',
    _d: 'm 129.9,343.2 -22.4,-0.6 -3.3,1.6 -4,-0.5 -6.5,2.3 0.7,2.9 3.7,3 -0.1,2.1 2.7,3.9 5.1,0.9 6.4,5.8 5.5,-6.8 3.7,0.3 3.2,-2.3 2.7,-0.1 1.9,-1.8 -0.9,-4.6 1.3,-1.4 0.3,-4.7 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    _id: 'GQ',
    '_data-name': 'Eq. Guinea',
    '_data-id': 'GQ',
    _d: 'm 433.9,486 -19.9,-0.3 -4.1,15.5 2.2,2.1 4.2,-0.8 17.7,0.2 -0.1,-16.7 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Liberia',
    '_data-id': 'LR',
    _d: 'm 193.3,411 -3.4,-0.4 -2.6,5.6 -3.4,-0.1 -2.4,-2.9 0.9,-5.6 -5.1,-8.5 -3.2,1.6 -2.6,0.3 -5.7,6.5 -5.5,7.5 -0.7,4 -2.9,4.4 8.1,8.9 10.4,7.6 11,10.5 12.6,6.6 3.2,-0.1 1,-11.4 1.1,-1.7 -0.3,-5.5 -5.2,-5.8 -3.8,-0.9 -3.6,-3.8 2.7,-6.1 -1.2,-6.7 0.6,-4 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Lesotho',
    '_data-id': 'LS',
    _d: 'm 625.3,939.9 2.5,-4.4 6.7,-2.2 2.4,-4.5 4.1,-6.7 -3.8,-4.2 -4.8,-4.2 -5.7,2.8 -6.8,5.4 -6.9,8.7 8,10.6 4.3,-1.3 z',
    _style: 'fill:#c7c583',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Namibia',
    '_data-id': 'NA',
    _d: 'm 576,759.7 -22.4,5.7 -29.1,-2 -8.2,-6.6 -48.8,0.6 -1.9,1 -7.1,-6.3 -7.8,-0.4 -7.2,2.3 -5.9,2.7 0.6,10.6 9.5,13.5 2.5,8.7 6,16.6 5.9,11.4 4.6,5.7 1.3,7.6 -0.1,16.5 3.4,21.3 2.6,10.1 2.2,13.4 4.3,10.1 8.3,10.5 6,-6.8 4.5,3.7 1.7,6 5.2,1 7.3,2.6 6.4,-1 10.8,-7.1 2.2,-51.1 1.4,-40.4 11.8,-0.5 1.9,-49.3 9,-0.4 18.7,-4.9 4.4,5.7 7.9,-5.4 3.6,0 6.9,-3.1 0,-1.2 -4.7,-3.1 -7.8,-0.8 -9.9,3.1 z',
    _style: 'fill:#c7c583',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Rwanda',
    '_data-id': 'RW',
    _d: 'm 667.9,533 -7.4,4.3 -2.9,-1.4 -3.5,3.8 -0.5,8.3 -1.7,1 -1.2,7.6 7.4,1.1 3.8,-7.9 6.5,0.9 0,0 3.5,-1.8 0.8,-8.1 -4.8,-7.8 z',
    _style: 'fill:#ff0303',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'W. Sahara',
    '_data-id': 'EH',
    _d: 'm 193.8,134.6 -1.8,0 0,0 0.1,7.5 -7.3,0.4 -3.9,3.2 -5.4,0 -4.2,-1.8 -10,1.4 -4.2,10.8 -3.7,1.1 -6,17.4 -16.9,15 -4.4,19.1 -5,6.2 -1.6,5 -27,1.1 -0.2,-0.1 -0.6,5.9 2.7,-4.6 46.9,0.1 -1.9,-20 3.1,-7.1 11.2,-1.3 0.4,-35.4 38.9,0.7 0.5,-20.9 0.3,-2.7 0,-1 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Senegal',
    '_data-id': 'SN',
    _d: 'm 148.8,315.1 -7.8,-9.5 -7.2,-10.2 -7.9,-3.7 -5.7,-4 -6.8,0.1 -5.9,3 -6,-1.2 -4.2,4.5 -3,7.1 -6.1,9.7 -5.4,2.6 6,4.9 4.8,10.8 13.2,-0.4 2.8,-3.3 3.8,-0.2 4.7,3.4 3.8,0.1 4,-2.3 2.4,4 -5.3,3.1 -5.2,-0.3 -5.2,-2.9 -4.5,3.2 -2.2,0.1 -3,1.9 -11,-0.2 1.8,10.6 6.5,-2.3 4,0.5 3.3,-1.6 22.4,0.6 5.8,0.1 8.7,3.4 2.7,-0.3 0.9,-1.6 6.6,1.1 1.8,-0.7 0.6,-4.4 -1,-5.3 -4.5,-3.9 -2.3,-7.9 -0.4,-8.6 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    _id: 'SL',
    '_data-name': 'Sierra Leone',
    '_data-id': 'SL',
    _d: 'm 171.5,401 -3.3,0.8 0.1,-5.1 -1.9,-3.6 0.4,-4 -2.6,-5.8 -3.3,-5 -9.7,0 -2.9,2.6 -3.3,0.3 -2.1,3 -1.5,3.8 -6.5,6.1 1.4,10.3 2.1,5 6.3,7.4 8.7,5.6 3.3,1 2.9,-4.4 0.7,-4 5.5,-7.5 5.7,-6.5 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    _id: 'SZ',
    '_data-name': 'Swaziland',
    '_data-id': 'SZ',
    _d: 'm 674,874.9 -5.8,-2.6 -3.5,1 -1.4,4 -3.6,5.2 -0.2,4.8 6.6,7.5 7,-1.5 2.8,-6.1 -0.6,-6.1 -1.3,-6.2 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'Chad',
    '_data-id': 'TD',
    _d: 'm 582.5,246.4 -48.7,-26.5 -48.4,-26.5 -11.9,7.6 3.4,21.5 4.6,3.6 0.3,4.4 5.1,4.7 -2.5,6 -4,28.1 -0.2,18 -15.2,13 -4.9,18.2 5.1,5.2 0.1,8.9 7.8,0.3 -1.1,6.5 4.9,8.9 1,9.1 -0.4,9.2 6.8,12.6 -6.8,-0.1 -3.4,0.9 -5.6,-1.3 -2.5,6.5 7.2,8.1 5.3,2.3 1.8,5.7 3.9,9.6 -1.8,3.7 10,-1 2.2,-3.6 2.1,0.3 3,3.1 15.3,-5.3 5.1,-5.4 6.3,-4.8 -1.2,-4.9 3.4,-1.2 11.8,0.8 11.3,-6.4 8.6,-15.1 6,-5.6 7.7,-2.3 0.1,-3.4 -4.6,-4.1 -0.3,-8 -2.6,-5.4 -4.3,0.8 1.2,-5 3,-5.8 -1.5,-5.7 3.8,-4.3 -2.6,-3.2 3,-8.5 5.2,-10.2 10.5,0.9 -2.4,-54.9 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'Togo',
    '_data-id': 'TG',
    _d: 'm 307.1,365.2 -10.7,-0.3 -0.9,4.3 5.1,7.1 0,10.1 1.2,10.9 3,5 -2.7,12.5 1,6.8 3.2,8.8 2.8,4.9 9.8,-3 -3,-9.5 0.5,-31.8 -2.5,-2.8 -0.4,-6.8 -4.3,-4.9 -3.7,-4.1 1.6,-7.2 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'Tunisia',
    '_data-id': 'TN',
    _d: 'm 429.5,59 -4.5,-2.2 -3.2,-6.6 -6,-0.2 -2.4,-7.6 7.3,-7 1.1,-12.1 -4.1,-3.5 -0.2,-6.5 5.5,-7 -0.9,-2.7 -9.5,5.2 0.1,-7.1 -8.1,-1.7 -12.2,5.7 -2.2,7.2 2.3,13.4 -2.4,11.6 -7,7.8 1.3,10.4 9.7,8.3 0.2,3.3 7.3,5.6 5.7,24.7 5.6,-3.2 0.9,-5.8 -1.5,-5.7 7.9,-5.3 3.4,-4.4 5.6,-4 0.3,-10.6 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
  ...
  },
  {
    ...
    '_data-name': 'Uganda',
    '_data-id': 'UG',
    _d: 'm 711.3,458.5 -7.4,6.4 -8.6,-0.1 -9.8,3.3 -7.8,-3.1 -5,3.8 0,0 -0.6,16.1 4.9,1.9 -3.9,4.9 -4.7,3.7 -4.6,7.2 -2.6,6.4 -0.6,11.1 -2.9,5.3 -0.1,10.5 2.9,1.4 7.4,-4.3 4.3,-1.7 13.4,0.2 0,0 -0.7,-5.3 5.7,-8.1 7.7,-2 5.2,-3.3 6.3,2.7 0.6,1 0,-0.7 3.5,-5.6 5.9,-9.2 4.4,-10.1 -5.5,-15.8 -1.5,-7 -5.9,-9.6 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    _id: 'ZA',
    '_data-name': 'South Africa',
    '_data-id': 'ZA',
  ...
  },
  {
    ...
    '_data-name': 'Zimbabwe',
    '_data-id': 'ZW',
    _d: 'm 669.1,825.1 13.4,-15.7 3.6,-9.9 1.9,-1.3 1.7,-8.1 -1.7,-4.1 1,-10.4 2.8,-9.6 0.8,-17.5 -6.1,-4.4 -5.7,-1 -2.5,-3.4 -5.5,-3 -10,0.3 -0.6,-5.1 -9.3,1.9 -7,5.5 -1.7,4.8 -4.4,1 -10.9,11.4 -7,9 -4.1,0.3 -3.8,-1.6 -13.4,-1.5 4.2,11.1 2.3,2.4 3.5,8 13,15.2 5.1,1.5 -0.2,4.9 3.1,8.8 9.2,2.1 7.3,6.2 4.9,0.2 5.7,2.3 4.1,-1.6 6.3,1.3 z',
    _style: 'fill:#f2f2f2',
  },
  {
    '_inkscape:connector-curvature': '0',
    ...
    '_data-name': 'Somalia',
    '_data-id': 'SO',
    _d: 'm 832.6,372.8 -5.7,-5.8 -2.5,-5.7 -4.1,-2.6 -4.2,7.4 -2.5,4.9 4.8,7.7 4.6,6.6 4.8,5 40.3,16.4 10.3,-0.1 -33.5,41.5 -15.9,0.6 -10.7,9.8 -7.8,0.2 -3.3,4.4 -10.5,15.7 0.4,50.4 7.2,11.4 2.7,-3.3 2.9,-7.3 13.4,-16.7 11.4,-10.6 18.1,-13.7 12.1,-11.2 14.1,-18.9 10.1,-15.5 10,-20.2 7,-17.7 5.4,-15.5 2.9,-14.9 2.4,-5 -0.4,-7.3 0.8,-8 -0.5,-3.9 -4.6,0.1 -5.5,4.7 -6.4,1.4 -5.5,2.1 -3.9,0.2 0,0 -6.9,0.5 -4.2,2.6 -6,0.9 -10.5,4.3 -13.2,1.6 -11.3,3.5 -6.1,0 z',
    _style: 'fill:#f2f2f2',
  },
];
</script>
